...
const Register = ({setLoginToggle}) => {
    ...
    return (
        <div className=' py-10 min-h-screen bg-blue-100 w-full'>
            <h1 className=' mb-10 text-center font-bold text-3xl'>Register Here</h1>
            ...
            <form onSubmit={(e) => submithandle(e)} className="max-w-md mx-auto border px-8 py-8 bg-white rounded-xl">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input value={age} onChange={(e) => agehandle(e)} type="number" name="floating_age" id="floating_age" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label htmlhtmlFor="floating_age" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Age</label>
                </div>
